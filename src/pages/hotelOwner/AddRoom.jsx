...
const AddRoom = () => {
  ...
  return (
    <form>
        ...
        <p className='text-grya-800 mt-10'>Images</p>
        ...
        <div className='w-full flex max:sm:flex-col sm:gap-4 mt-4'>
            ...
            <div>
                ...
                <input type="number" placeholder='0' className='border boder-gray-300 mt-1 rounded p-2 w-24' value={inputs.pricePerNight} onChange={e=>setInputs({...inputs, pricePerNight: e.target.value})} />
            </div>
        </div>
